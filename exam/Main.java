...
public class Main {
    public static void main(String[] args) {
        ArrayList<Employee> employees = new ArrayList<>() {
            {
                add(new Employee("1", "thang1", LocalDate.parse("2001-12-12"), "Nghe An", 2, List.of(LocalDateTime.parse("2012-01-12T07:30:20"), LocalDateTime.parse("2012-02-12T07:35:20"), LocalDateTime.parse("2012-03-12T07:35:20"), LocalDateTime.parse("2012-02-12T07:35:20"))));
